                        ...
                        <Tablestyled.Body revert>
                            <Tablestyled.Row>
                                ...
                                <Tablestyled.CellDescription as="td">
                                    <p>{t(`gpItem.gpDepth1.group21.item11`)}</p>
                            ...
                            <Tablestyled.Row>
                                ...
                                <Tablestyled.CellDescription as="td">
                                    <p>{t(`gpItem.gpDepth1.group21.item12`)}</p>
                                </Tablestyled.CellDescription>
                            </Tablestyled.Row>
                            ...
                            <Tablestyled.Row>
                                ...
                                <Tablestyled.CellDescription as="td">
                                    <p>{t(`gpItem.gpDepth1.group21.item13`)}</p>
                                </Tablestyled.CellDescription>
                            </Tablestyled.Row>
                        </Tablestyled.Body>
                    </Tablestyled.Table>
                    ...
                    <Tablestyled.Table className="type02 type04 col2">
                        ...
                        <Tablestyled.Body revert>
                            <Tablestyled.Row>
                                <Tablestyled.CellDescription as="td">{t(`gpItem.gpDepth1.group20.top`)}</Tablestyled.CellDescription>
                                <Tablestyled.CellDescription as="td">
                                    <p>{t(`gpItem.gpDepth1.group21.item14`)}</p>
                                </Tablestyled.CellDescription>
                            </Tablestyled.Row>
                            ...
                            <Tablestyled.Row>
                                <Tablestyled.CellDescription as="td">{t(`gpItem.gpDepth1.group20.middle`)}</Tablestyled.CellDescription>
                                <Tablestyled.CellDescription as="td">
                                    <p>{t(`gpItem.gpDepth1.group21.item15`)}</p>
                                </Tablestyled.CellDescription>
                            </Tablestyled.Row>
                            ...
                            <Tablestyled.Row>
                                <Tablestyled.CellDescription as="td">{t(`gpItem.gpDepth1.group20.bottom`)}</Tablestyled.CellDescription>
                                <Tablestyled.CellDescription as="td">
                                    <p>{t(`gpItem.gpDepth1.group21.item16`)}</p>
                                </Tablestyled.CellDescription>
                            </Tablestyled.Row>
                        </Tablestyled.Body>
                    </Tablestyled.Table>
                    ...
                    <Tablestyled.Table className="type02 type04 col2">
                        ...
                        <Tablestyled.Body revert>
                            <Tablestyled.Row>
                                ...
                                <Tablestyled.CellDescription as="td">
                                    <p>{t(`gpItem.gpDepth1.group21.item`)}</p>
                                    <p>{t(`gpItem.gpDepth1.group21.item3`)}</p>
                                    <p>{t(`gpItem.gpDepth1.group21.item5`)}</p>
                                    <p>{t(`gpItem.gpDepth1.group21.item7`)}</p>
                                    <p>{t(`gpItem.gpDepth1.group21.item9`)}</p>
                    ...
                    <Tablestyled.Table className="type02 type04 col2">
                        ...
                        <Tablestyled.Body revert>
                            <Tablestyled.Row>
                                ...
                                <Tablestyled.CellDescription as="td">
                                    <p>{t(`gpItem.gpDepth1.group21.item2`)}</p>
                                    <p>{t(`gpItem.gpDepth1.group21.item4`)}</p>
                                    <p>{t(`gpItem.gpDepth1.group21.item6`)}</p>
                                    <p>{t(`gpItem.gpDepth1.group21.item8`)}</p>
                                    <p>{t(`gpItem.gpDepth1.group21.item10`)}</p>
                                    <p>{t(`gpItem.gpDepth1.group19.item3`)}</p>
                                </Tablestyled.CellDescription>
                            </Tablestyled.Row>
                            <Tablestyled.Row>
